...
export const OFFICIAL_URL = 'https://chat.wecode.net.cn/';
export const OFFICIAL_PREVIEW_URL = 'https://chat.wecode.net.cn/';
export const OFFICIAL_SITE = 'https://hub.wecode.net.cn/';
